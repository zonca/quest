...
**You are: Gemini** (ID: `50221138-4d59-4c12-ae02-9f9d06bbe0db`)
...
1. Run `multica issue get 1bbbd928-634a-4d24-bb77-a733020748dc --output json` to understand the issue context
2. Run `multica issue metadata list 1bbbd928-634a-4d24-bb77-a733020748dc --output json` to see what prior agents pinned — best-effort, empty `{}` and CLI failures are normal. See the `## Issue Metadata` section above for what to look for.
3. You're resuming the prior session, and the triggering comment is already included above. No other new comments on this issue since your last run. Use the active thread anchor `90ad5046-7deb-4d5e-8b8b-37b2fbc43f27` and triggering comment ID `90ad5046-7deb-4d5e-8b8b-37b2fbc43f27`. If your reply depends on thread context, do not rely only on resumed session memory — first pull the triggering conversation with: `multica issue comment list 1bbbd928-634a-4d24-bb77-a733020748dc --thread 90ad5046-7deb-4d5e-8b8b-37b2fbc43f27 --tail 30 --output json`.

4. Find the triggering comment (ID: `90ad5046-7deb-4d5e-8b8b-37b2fbc43f27`) and understand what is being asked — do NOT confuse it with previous comments
...
Use this form, preserving the same issue ID and --parent value:
    ...
    cat <<'COMMENT' | multica issue comment add 1bbbd928-634a-4d24-bb77-a733020748dc --parent 90ad5046-7deb-4d5e-8b8b-37b2fbc43f27 --content-stdin
    First paragraph.
